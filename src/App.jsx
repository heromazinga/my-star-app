...
const EXTRA_DATA = {
  leo:{
    mythFull: "【배경】 헤라클레스는 사실 신의 아들인데도 참 억울한 인생을 살았어요. 헤라 여신의 질투로 광기에 빠져 자기 아이들을 죽이는 비극을 저질렀고, 그 속죄로 에우리스테우스 왕의 명령을 12번 수행해야 했습니다. 첫 번째 명령이 바로 네메아의 사자 처치였어요. 네메아 계곡을 공포에 떨게 한 이 사자, 그냥 사자가 아니었습니다. 달의 여신이 키웠다는 설도 있고, 하늘에서 떨어진 신성한 짐승이라는 설도 있는데 — 어쨌든 이 사자의 황금빛 가죽은 어떤 무기로도 뚫리지 않았어요. 【사건】 헤라클레스가 화살을 쐈더니 튕겨나가고, 칼로 베었더니 칼날이 구부러지고, 창을 던졌더니 부러졌습니다. 결국 헤라클레스는 선택의 여지가 없었어요 — 맨손. 동굴 속으로 쫓아 들어가 사자의 목을 두 팔로 조이기 시작했습니다. 신의 피가 섞인 헤라클레스의 힘이었지만, 사자도 어마어마하게 발버둥쳤을 거예요. 긴 사투 끝에 사자는 결국 쓰러졌고, 헤라클레스는 사자의 발톱으로 그 황금 가죽을 벗겨냈습니다. 이후 이 가죽이 그의 트레이드마크 외투가 됐죠. 【결말】 에우리스테우스 왕은 사자 가죽을 두른 헤라클레스가 보고 싶다고 했다가, 실제로 나타나자 너무 무서워서 항아리에 숨었다고 해요. 제우스는 아들의 첫 과업 성공을 기려 사자를 하늘에 올렸습니다. 헤라클레스가 처치한 사자가 하늘에서 빛나는 셈이죠. 사자자리의 빛나는 레굴루스가 사자의 심장 부위에 해당하는데, 헤라클레스는 그 다음에 게자리 인근의 레르나 늪으로 가서 히드라와 싸우게 됩니다.",
  ...
  ursaMajor:{
    mythFull: "【배경】 아르테미스 여신의 시중을 드는 님프들은 순결 서약이 필수였어요. 칼리스토도 그 일원이었는데, 제우스가 그녀에게 눈독을 들였습니다. 문제는 칼리스토가 아르테미스에게 헌신하는 신실한 님프였다는 것. 제우스는 아예 아르테미스로 변장해서 접근했어요. 방심한 칼리스토는 뒤늦게 속은 걸 알았지만 이미 임신한 상태였습니다. 한참 후 아르테미스가 님프들과 목욕하다가 칼리스토의 배를 보고 쫓아냈고, 질투에 불탄 헤라는 칼리스토를 거대한 곰으로 만들어버렸습니다. 【사건】 수십 년이 흘렀습니다. 곰이 된 칼리스토는 숲을 떠돌았고, 그 사이 아들 아르카스는 훌륭한 사냥꾼으로 자랐습니다. 운명은 가혹했어요 — 어느 날 아르카스가 자신을 향해 다가오는 큰 곰을 창으로 겨냥했습니다. 그 곰이 자기 어머니인 줄은 꿈에도 몰랐겠죠. 칼리스토는 아들을 알아보고 다가갔지만, 아르카스 눈에는 그냥 위협적인 곰이었습니다. 창이 날아가려는 그 순간, 제우스가 개입했습니다. 둘 다 하늘로 올려 큰곰자리와 작은곰자리로 만든 거예요. 【결말】 헤라는 이것도 용납 못 했습니다. '감히 그 여자를 별로 만들어?'라며 바다의 신 오케아노스에게 두 곰이 절대 바다에서 쉬지 못하게 해달라고 부탁했어요. 그래서 북두칠성은 서울에서 일 년 내내 지지 않는 주극성이 된 거랍니다. 헤라의 저주가 오히려 가장 잘 보이는 별자리를 만들었다는 게 아이러니하죠. 국자 끝 두 별을 다섯 배 연장하면 북극성 — 어머니 칼리스토가 아들 아르카스(작은곰자리)를 영원히 품고 있는 모습이에요.",
  ...
  virgo:{
    mythFull: "【배경】 처녀자리에는 두 여신의 이야기가 겹쳐있어요. 먼저 정의의 여신 아스트라이아. 아주 먼 옛날 황금 시대에는 신들이 인간과 함께 지상에서 살았답니다. 그런데 인간이 점점 탐욕스럽고 폭력적으로 변해가면서, 신들은 하나둘 올림포스로 도망쳤어요. 아프로디테도 가고, 아레스도 가고. 아스트라이아만 마지막까지 인간 곁에 남아 정의를 지키려 했습니다. 결국 그녀도 포기하고 하늘로 올라가 처녀자리가 되었고, 손에 든 저울이 바로 옆의 천칭자리가 됐어요. 【사건】 처녀자리의 또 다른 주인공은 페르세포네. 봄꽃 향기 가득한 들판에서 꽃을 꺾던 페르세포네 앞에 갑자기 땅이 갈라지더니, 지하세계의 왕 하데스가 나타나 그녀를 납치했습니다. 어머니 데메테르는 딸을 찾아 세상을 헤매며 울었고, 곡식의 여신인 그녀가 슬퍼하는 동안 땅에서는 아무것도 자라지 않았어요. 사람들이 굶어 죽어갈 지경이 되자, 제우스도 더 이상 못 본 체할 수 없었습니다. 하데스와 협상했는데, 문제는 페르세포네가 이미 명계의 음식(석류 씨앗 여섯 알)을 먹어버린 것. 【결말】 협상 결과 페르세포네는 1년 중 절반만 어머니 곁에 있을 수 있게 됐어요. 봄과 여름에는 페르세포네가 지상으로 올라오고, 기뻐한 데메테르가 꽃과 곡식을 피웁니다. 가을이 되면 페르세포네가 다시 명계로 내려가고, 데메테르의 슬픔이 겨울을 만들어요. 처녀자리가 봄 하늘에 뜨는 이유가 바로 이 때문이랍니다. 스피카를 찾으려면 북두칠성 손잡이 곡선을 따라 목동자리 아크투루스까지 온 다음, 같은 방향으로 더 뻗으면 돼요.",
  ...
  bootes:{
    mythFull: "【배경】 아크투루스는 '곰의 수호자'라는 뜻이에요. 하늘에서 큰곰자리를 몰고 다니는 목동, 그게 바로 목동자리입니다. 그런데 목동자리에는 훨씬 드라마틱한 이야기가 따로 있어요. 주인공은 이카리오스. 평범한 아테네 농부였던 그에게 어느 날 포도주의 신 디오니소스가 직접 찾아왔습니다. 신이 술 만드는 법을 직접 가르쳐준 것 — 신성한 지식을 인간에게 전달한 셈이죠. 이카리오스는 감격해서 마을 사람들에게 그 포도주를 나눠주기 시작했습니다. 【사건】 문제가 생겼어요. 포도주를 한 번도 마셔본 적 없는 마을 사람들이 갑자기 머리가 빙빙 돌고 쓰러지는 거예요. 당연히 '이카리오스가 우리를 독살하려 한다'고 오해했습니다. 화가 난 사람들은 이카리오스를 죽이고 숲속에 묻어버렸어요. 이카리오스의 딸 에리고네는 아버지를 찾아 온 들판을 헤매었는데, 그 곁에는 아버지의 충직한 사냥개 마이라가 있었습니다. 마이라가 짖고 또 짖으며 숨겨진 무덤을 찾아냈고, 에리고네는 아버지의 시신 앞에서 절망해 스스로 목숨을 끊었어요. 【결말】 제우스가 이 비극적인 부녀를 불쌍히 여겨 하늘에 올렸습니다. 이카리오스가 목동자리, 에리고네가 처녀자리, 사냥개 마이라가 작은개자리가 됐다는 이야기입니다. 그래서 봄 하늘에는 이 세 별자리가 나란히 있어요 — 북두칠성 손잡이를 따라 내려오면 오렌지빛 아크투루스(목동자리), 계속 이으면 청백색 스피카(처녀자리). 이게 유명한 봄의 대곡선입니다.",
  ...
  scorpius:{
    mythFull: "【배경】 오리온은 포세이돈의 아들로 태어난 거인 사냥꾼이었어요. 바다 위를 걸을 수 있었고, 어깨 너비만 해도 웬만한 산을 넘을 것 같은 체격이었습니다. 사냥 실력도 타의 추종을 불허했는데, 문제는 자만심이 함께 자랐다는 거예요. 어느 날 오리온이 대지의 여신 가이아가 듣는 앞에서 큰소리를 쳤습니다. '나는 세상의 모든 동물을 다 잡을 수 있다!' 대지에 사는 모든 생명의 어머니인 가이아한테는 선전포고나 다름없었어요. 【사건】 가이아는 즉시 거대한 전갈을 땅에서 불러냈습니다. 전갈은 오리온이 잡을 수 없는 상대였어요. 아무리 강한 사냥꾼도 독침 한 방이면 끝이니까요. 오리온과 전갈은 치열하게 싸웠고, 결국 전갈의 독침이 오리온을 쓰러뜨렸습니다. 또 다른 버전도 있어요. 아폴론이 누이 아르테미스를 꾀어서 '저기 바다에 떠 있는 점을 맞혀봐'라고 했고, 아르테미스가 쏜 화살이 그게 오리온인 줄 모르고 맞혔다는 이야기예요. 어느 버전이든 결말은 같습니다. 【결말】 제우스는 두 존재를 모두 하늘에 올렸는데, 딱 하나 신경 썼어요 — 둘이 하늘에서 마주치면 또 싸울 테니, 정반대편에 배치한 겁니다. 그래서 전갈자리가 동쪽 지평선에서 떠오르면, 오리온자리는 서쪽 지평선 아래로 집니다. 오리온자리가 겨울 하늘의 주인공이고, 전갈자리가 여름 하늘의 주인공인 이유가 바로 이것 때문이에요. 두 숙적은 계절이 바뀌듯 영원히 번갈아 하늘을 지킵니다. 전갈의 심장 안타레스는 '화성에 대항하는 별'이라는 뜻으로, 화성과 색깔이 비슷해서 붙은 이름이에요.",
  ...
  cygnus:{
    mythFull: "【배경】 백조자리에는 두 이야기가 얽혀있는데, 둘 다 슬픔이 핵심이에요. 먼저 태양신 헬리오스의 아들 파에톤 이야기. 파에톤은 아버지를 증명하고 싶어서 태양 마차를 하루만 몰게 해달라고 졸랐습니다. 헬리오스는 극구 말렸지만 결국 허락했어요. 그런데 경험 없는 파에톤이 마차를 통제하지 못했습니다. 너무 높이 올라가면 별자리들이 위협적으로 달려들고, 너무 낮게 내려오면 지상을 태워버리는 상황이 반복됐어요. 【사건】 지구가 불타기 시작하자 제우스가 번개를 던져 파에톤을 강에 떨어뜨려 죽였습니다. 파에톤의 절친한 친구 퀴크노스는 에리다누스 강가에 앉아 친구를 잃은 슬픔에 통곡했어요. 강 속 어딘가에 가라앉은 파에톤의 시신을 건지려고 잠수를 반복했습니다. 날이 가고 달이 갈수록 슬픔에 잠긴 퀴크노스의 목은 점점 길어지고, 피부는 하얗게 변했습니다. 목이 구부러지고 날개가 돋아났어요 — 그렇게 퀴크노스는 백조가 됐습니다. 【결말】 아폴론이 퀴크노스의 슬픔을 가엾이 여겨 하늘에 올렸어요. 백조자리의 꼬리별 데네브가 찬란하게 빛나는데, 데네브는 약 2,600광년 거리에 있는 초거성으로 실제 밝기가 태양의 20만 배에 달합니다. 이렇게 멀리 있어도 밝게 빛나는 거예요. 여름 밤하늘에서 데네브(백조자리), 베가(거문고자리), 알타이르(독수리자리)를 이으면 여름 대삼각형이 완성됩니다. 은하수 한가운데를 날개를 펼치고 날아가는 백조의 모습, 여름 밤에 꼭 찾아보세요.",
  ...
  lyra:{
    mythFull: "【배경】 오르페우스는 음악의 신 아폴론의 아들이에요. 그의 리라 연주는 그냥 아름다운 수준이 아니었습니다. 강물이 흐르다가 멈추고, 나무들이 걸어와 가까이 듣고, 사나운 맹수들이 얌전하게 앉아 귀를 기울이는 수준이었어요. 오르페우스는 님프 에우리디케와 사랑에 빠져 결혼했는데, 결혼식 날 에우리디케가 들판을 걷다가 뱀에 발꿈치를 물려 그 자리에서 죽고 말았습니다. 갓 결혼한 첫날의 비극이었어요. 【사건】 오르페우스는 슬픔을 이기지 못하고 산 채로 지하세계로 내려갔습니다. 죽은 자들의 영혼이 사는 곳에 산 인간이 걸어 들어간 거예요. 리라를 연주하며 걸어가자 죽은 영혼들이 멈춰 섰고, 저승의 뱃사공 카론도, 지옥의 개 케르베로스도 얌전해졌습니다. 하데스와 페르세포네 앞에 서서 연주했을 때, 한 번도 눈물을 흘린 적 없다는 하데스가 눈물을 흘렸어요. '지상에 나갈 때까지 절대 뒤를 돌아보지 말라'는 조건으로 에우리디케를 돌려받았습니다. 【결말】 긴 어둠의 터널을 지나 출구가 눈앞에 보이는 순간, 오르페우스는 에우리디케가 정말 따라오고 있는지 확인하고 싶었어요. 딱 한 번만 돌아봤습니다. 에우리디케의 얼굴을 본 순간, 그녀는 다시 명계로 사라졌어요. 오르페우스는 다시 내려가려 했지만 두 번째 입장은 허락되지 않았습니다. 이후 오르페우스는 슬픔 속에 살다 죽었고, 제우스가 그의 리라를 하늘에 올렸어요. 가장 밝은 별 베가는 여름 밤하늘에서 제일 먼저 눈에 들어오는 별입니다. 데네브(백조자리), 알타이르(독수리자리)와 함께 여름 대삼각형을 이루죠.",
  ...
  aquila:{
    mythFull: "【배경】 트로이에는 가니메데스라는 소년이 있었어요. 트로이 왕의 아들인데, 신화에서 '인간 중 가장 아름다운 존재'라고 묘사될 만큼 빼어난 미모였습니다. 올림포스의 신들도 소문을 들었고, 제우스도 듣게 됐어요. 신들의 잔칫상에 술을 따르는 시종 자리가 마침 비어있었는데, 제우스는 가니메데스가 딱이라고 생각했습니다. 문제는 가니메데스가 트로이 땅에 있다는 것 — 직접 데려와야 했어요. 【사건】 제우스는 독수리로 변신하거나, 독수리를 보내는 방법을 택했습니다. 신화 버전마다 조금씩 달라요. 어느 날 트로이 들판에서 양을 돌보던 가니메데스 앞에 거대한 독수리가 내려앉더니, 그를 발톱으로 낚아채 하늘로 올라갔습니다. 트로이 왕은 아들이 사라진 걸 알고 절망했는데, 제우스가 전령 헤르메스를 보내 사정을 설명하고 불멸의 말 두 마리를 보상으로 주었어요. 【결말】 가니메데스는 올림포스에서 신들에게 술을 따르는 시종이 됐습니다. 그 모습이 하늘의 물병자리예요. 제우스는 가니메데스를 데려온 독수리도 하늘에 올려 독수리자리로 만들었습니다. 독수리자리의 알타이르는 양쪽으로 별 하나씩을 거느린 3연성 배치가 인상적인데, 날개를 펼친 독수리 모습을 잘 표현하고 있어요. 한국 칠석 전설에서 알타이르는 견우성, 건너편 거문고자리의 베가가 직녀성입니다. 은하수를 사이에 두고 일 년에 한 번, 7월 7일에만 만난다는 그 이야기예요.",
  ...
  orion:{
    mythFull: "【배경】 오리온은 포세이돈의 아들이자 바다 위를 걸을 수 있는 거인 사냥꾼이었어요. 사냥의 여신 아르테미스와 오누이처럼 어울리며 함께 사냥을 즐길 만큼 실력이 출중했습니다. 문제는 오리온이 아르테미스에게 점점 특별한 감정을 갖게 됐다는 거예요. 아르테미스도 오리온을 특별하게 여겼고, 결혼을 고려한다는 이야기까지 나왔습니다. 오리온의 쌍둥이 오빠 아폴론은 이 관계가 몹시 못마땅했어요. 순결 서약을 고수하던 누이가 인간과 결혼한다는 게 용납이 안 됐던 거죠. 【사건】 아폴론은 꾀를 냈습니다. 어느 날 오리온이 바다를 걷고 있을 때, 아폴론이 아르테미스에게 다가갔어요. '저기 저 점 맞힐 수 있겠어?' 활의 신인 아르테미스에게 자존심을 건드리는 도발이었죠. 아르테미스는 멀리 파도 위에 어른거리는 점을 향해 화살을 쐈고, 정확히 맞혔습니다. 파도에 떠밀려온 시신을 보고서야 그게 오리온이었다는 걸 알았어요. 아르테미스는 통곡했지만 이미 돌이킬 수 없었습니다. 【결말】 아르테미스는 오리온을 하늘에 올려 가장 화려한 별자리로 만들었어요. 오리온의 충직한 사냥개 시리우스도 함께 올라가 큰개자리가 됐습니다. 전갈자리와의 악연도 있어요 — 전갈자리가 동쪽에서 뜨면 오리온자리는 서쪽으로 집니다. 제우스가 두 숙적이 하늘에서 마주치지 않도록 정반대편에 배치했기 때문이에요. 오리온의 허리띠 세 별에서 아래로 내려가면 오리온 대성운 M42가 있는데, 겨울 밤 가장 아름다운 딥스카이 중 하나입니다.",
  ...
  taurus:{
    mythFull: "【배경】 제우스는 변신의 달인이에요. 황소자리의 주인공은 제우스가 페니키아의 공주 에우로파에게 접근하기 위해 변신한 새하얀 황소입니다. 에우로파는 시돈 해변에서 꽃을 꺾고 있었는데, 무리에서 벗어나 홀로 자기 쪽으로 다가오는 유난히 아름다운 흰 황소를 발견했어요. 뿔이 달처럼 반달 모양이고, 이마에는 은빛 별이 하나 빛나는, 어디서도 본 적 없는 신비로운 황소였습니다. 거기다 성격이 어찌나 온순한지 발치에 와서 꽃향기를 맡을 정도였어요. 【사건】 에우로파는 경계심을 풀고 황소 등에 꽃을 얹었다가, 결국 올라타고 말았습니다. 그 순간 황소가 벌떡 일어나 바다를 향해 달리기 시작했어요. 에우로파가 소리를 질렀지만 황소는 멈추지 않았고, 파도를 가르며 크레타 섬까지 달려갔습니다. 크레타에 도착한 황소가 제우스의 모습으로 돌아왔을 때, 에우로파는 자신을 납치한 게 신들의 왕이었다는 걸 알았어요. 이 결합에서 크레타의 왕 미노스가 태어났고, 훗날 미노타우로스가 탄생하는 씨앗이 됩니다. 【결말】 제우스는 황소의 모습을 하늘에 올려 황소자리로 만들었어요. 황소자리에는 볼거리가 두 가지 있습니다. 하나는 플레이아데스 성단 — 아틀라스의 일곱 딸이 오리온에게 쫓기다 비둘기로 변해 하늘에 올라간 것인데, 한 자매가 슬픔으로 숨어버려 맨눈으로는 여섯 개만 보인다는 전설이 있어요. 다른 하나는 히아데스 성단과 붉은 별 알데바란 — 황소의 눈에 해당하는 이 별이 오리온을 노려보는 것처럼 보입니다.",
  ...
  gemini:{
    mythFull: "【배경】 쌍둥이자리의 카스토르와 폴룩스는 태어날 때부터 달랐어요. 어머니 레다는 같은 날 밤 스파르타 왕 틴다레오스와 백조로 변신한 제우스를 동시에 만났습니다. 그 결과 두 개의 알이 나왔는데, 한 알에서는 인간의 피를 받은 카스토르와 헬레네가, 다른 알에서는 신의 피를 받은 폴룩스와 클리타임네스트라가 태어났어요. 카스토르는 뛰어난 기수였고, 폴룩스는 권투의 달인이었습니다. 둘은 함께 이아손의 아르고 원정대에도 참여했고, 항상 붙어다니는 환상의 콤비였어요. 【사건】 어느 전투에서 카스토르가 치명상을 입고 쓰러졌습니다. 인간의 피를 받은 카스토르는 죽을 수밖에 없었어요. 폴룩스는 신의 피를 받아 불멸이었지만, 형이 없는 영원한 삶은 의미가 없었습니다. 폴룩스는 제우스 앞에 나아가 간청했어요. '제 불멸의 삶 절반을 카스토르에게 나눠주세요.' 아버지 제우스도 이 형제애에 감동했는지, 특별한 방법을 허락했습니다. 【결말】 이후 카스토르와 폴룩스는 하루씩 번갈아 올림포스와 하데스를 오가게 됐어요. 한 명이 올림포스에 있을 때 다른 한 명은 지하세계에 있는 것이지만, 그래도 완전히 헤어지는 것보다는 나았습니다. 둘은 뱃사람들의 수호신이 됐어요. 폭풍우 치는 밤 뱃머리에 나타나는 푸른 불꽃 '세인트 엘모의 불'이 이 형제의 현현이라고 믿었습니다. 쌍둥이자리의 두 밝은 별 카스토르와 폴룩스는 나란히 붙어있어서, 한번 알면 절대 헷갈리지 않아요.",
  ...
  canisMajor:{
    mythFull: "【배경】 큰개자리는 오리온의 충직한 사냥개입니다. 오리온이 하늘로 올라갈 때 함께 올라간 거예요. 그런데 큰개자리의 주인공 시리우스에게는 훨씬 오래된 이야기가 따로 있습니다. 이집트 문명의 이야기예요. 나일 강은 해마다 범람했는데, 이 범람이 이집트 농업의 생명줄이었습니다. 범람이 너무 적으면 가뭄, 너무 많으면 홍수 — 딱 알맞게 범람해야 풍년이 들었어요. 이집트인들은 수천 년 동안 이 범람의 시기를 예측하는 방법을 찾았고, 결국 하늘에서 답을 찾았습니다. 【사건】 시리우스가 새벽 동쪽 지평선에서 태양보다 먼저 떠오르는 날 — 그리스인들이 '헬리아칼 라이징'이라 부르는 그 날 — 이 나일 강 범람의 시작과 정확히 일치했어요. 이집트인들은 시리우스를 이시스 여신의 별로 여기며 신성시했고, 시리우스의 출현이 새해의 시작이자 풍요의 신호였습니다. 기자 대피라미드의 주요 통로가 시리우스를 향하도록 설계됐다는 이론도 있어요. 한편 그리스인들은 시리우스가 태양과 함께 뜨는 7~8월의 혹독한 더위를 '개의 날들(Dog Days)'이라 불렀고, 이 폭염이 시리우스의 열기 때문이라고 믿었습니다. 【결말】 동양에선 시리우스를 천랑성(天狼星), 하늘의 이리라 불렀어요. 밝게 빛나는 모습이 이리처럼 사납다고 본 거죠. 전쟁이나 기근의 흉조로 여기기도 했습니다. 같은 별을 보고 이집트는 풍요의 신호로, 그리스는 폭염의 원인으로, 동양은 전쟁의 예고로 읽었다는 게 흥미롭죠. 밤하늘 전체에서 가장 밝은 별이니, 겨울 남쪽 하늘에서 찾기는 정말 쉽습니다.",
  ...
  auriga:{
    mythFull: "【배경】 마차부자리의 밝은 별 카펠라(Capella)는 라틴어로 '암염소'라는 뜻이에요. 이름에 담긴 이야기는 제우스의 유년 시절로 거슬러 올라갑니다. 크로노스는 자식에게 권좌를 빼앗긴다는 신탁을 두려워해 아이가 태어날 때마다 삼켜버렸어요. 막내 제우스는 어머니 레아가 강보에 돌을 싸서 크로노스를 속이고, 크레타 섬 이다 산의 동굴에 숨겨 키웠습니다. 아기 제우스를 키운 건 크레타의 님프 아말테아였는데, 아말테아의 염소 젖이 제우스의 유일한 식량이었어요. 【사건】 아기 제우스는 힘이 넘쳤습니다. 어느 날 장난을 치다가 아말테아의 염소 뿔을 그만 부러뜨리고 말았어요. 미안해진 제우스는 부러진 뿔에 특별한 힘을 불어넣었습니다. 원하는 것이면 무엇이든 가득 채워지는 풍요의 뿔, 코르누코피아가 된 거예요. 지금도 풍요를 상징하는 그림에 뿔 모양 바구니에서 과일과 곡식이 넘쳐흐르는 모습이 자주 등장하는데, 그게 바로 코르누코피아입니다. 제우스는 커서 아말테아를 하늘의 별로 올려 보답했어요. 【결말】 마차부자리의 또 다른 이야기는 아테네 왕 에리크토니오스예요. 대장장이 신 헤파이스토스의 아들로 태어났는데, 다리가 불편한 몸으로 살았습니다. 하지만 그 불편함이 발명의 어머니가 됐어요 — 네 마리 말이 끄는 전차를 직접 설계하고 만들어 이동했습니다. 제우스가 이 창의성에 감탄해 하늘에 올렸다고 해요. 마차부자리의 카펠라는 겨울 밤하늘에서 노란빛으로 빛나며, 오리온자리 위쪽에서 쉽게 찾을 수 있습니다.",
  ...
  cassiopeia:{
    mythFull: "【배경】 카시오페이아는 에티오피아의 왕비였어요. 딸 안드로메다의 미모를 자랑하다가 포세이돈의 분노를 사고, 결국 딸을 괴물의 제물로 바치는 비극을 초래한 장본인이죠. 그 이야기는 안드로메다자리에서 다뤘으니, 여기서는 카시오페이아 본인에게 집중해볼게요. 허영심 많은 왕비였지만, 딸이 바위에 묶인 걸 보면서 얼마나 후회했을지는 짐작이 가요. 페르세우스가 딸을 구하고 결혼했을 때 카시오페이아가 어떤 표정을 지었는지, 신화는 자세히 말해주지 않습니다. 【사건】 카시오페이아의 벌은 딸이 구출된 뒤에도 끝나지 않았어요. 포세이돈은 왕비의 허영심에 대한 대가를 끝까지 치르게 했습니다. 카시오페이아는 하늘로 올라간 후 의자에 묶인 채 북극성 주위를 영원히 돌게 됐어요. 1년의 절반은 왕비답게 앉아있지만, 나머지 절반은 의자가 뒤집히면서 거꾸로 매달린 채 돌아다닙니다. 왕비가 하늘에서 거꾸로 매달려 다니는 모습이니, 벌치고는 꽤 굴욕적이죠. 【결말】 덕분에 카시오페이아자리는 북극성 주위를 도는 주극성으로, 서울에서 일 년 내내 볼 수 있어요. W자 모양 다섯 별이 무척 인상적이라 한번 익히면 절대 잊어버리지 않는 별자리입니다. 북두칠성을 찾기 어려울 때 카시오페이아로 북극성을 찾는 방법도 있어요 — W자의 가운데 뾰족한 방향으로 선을 그으면 북극성이 나옵니다. 허영심의 벌로 하늘에 올라간 왕비가, 오히려 길잡이 별자리가 된 셈이에요.",
  ...
  andromeda:{
    mythFull: "【배경】 에티오피아 왕비 카시오페이아가 저지른 실수가 발단이었어요. '내 딸 안드로메다가 바다 님프들보다 훨씬 아름답다'고 큰소리를 쳤거든요. 바다 님프들이 발끈해서 포세이돈에게 항의했고, 포세이돈은 에티오피아를 향해 바다 괴물 케투스를 보냈습니다. 괴물이 해안을 휩쓸고 사람들을 잡아먹자 왕이 신탁을 구했는데, 돌아온 답이 끔찍했어요. '공주 안드로메다를 바위에 묶어 괴물에게 제물로 바쳐야 재앙이 멈춘다.' 어머니의 허영심 때문에 아무 잘못 없는 딸이 제물이 된 거예요. 【사건】 안드로메다가 바닷가 바위에 쇠사슬로 묶여있을 때, 메두사를 처치하고 귀환하던 페르세우스가 하늘을 날다가 그 광경을 목격했습니다. 바위에 묶인 안드로메다를 보자마자 반해버린 페르세우스는 왕에게 '내가 괴물을 처치할 테니 안드로메다와 결혼하게 해달라'고 했어요. 왕이 허락했고, 케투스가 나타나자 페르세우스는 메두사의 잘린 머리를 꺼내 괴물의 눈을 마주치게 했습니다. 돌로 굳어버린 케투스는 그대로 바닷속으로 가라앉았어요. 【결말】 페르세우스와 안드로메다는 결혼해서 행복하게 살았고, 둘 다 하늘의 별자리가 됐습니다. 안드로메다자리에는 하늘에서 가장 유명한 딥스카이 천체가 있어요. M31 안드로메다 은하 — 약 250만 광년 거리인데 맨눈으로 보입니다. 이 은하가 지금 우리 은하를 향해 다가오고 있어서, 약 45억 년 후에는 두 은하가 충돌해 합쳐질 예정이에요. 천문학자들은 그 결과를 '밀코메다'라고 부릅니다.",
  ...
  perseus:{
    mythFull: "【배경】 페르세우스의 탄생도 드라마틱했어요. 외할아버지 아크리시오스 왕이 '손자에게 죽임을 당한다'는 신탁을 받고, 딸 다나에를 아예 청동 탑 속에 가뒀습니다. 그런데 제우스가 황금 비로 변해 탑 안으로 스며들었고, 페르세우스가 태어났어요. 아크리시오스는 모녀를 나무 상자에 넣어 바다에 띄워 보냈지만, 둘 다 살아서 섬에 닿았습니다. 섬의 왕이 다나에에게 청혼하면서 페르세우스에게 메두사의 머리를 가져오라는 무모한 미션을 내린 것이 이야기의 시작이에요. 【사건】 메두사는 눈을 마주치면 돌로 굳어버리는 고르곤 세 자매 중 하나였어요. 페르세우스는 아테나에게 거울처럼 쓸 수 있는 청동 방패를, 헤르메스에게 날개 달린 신발과 신들의 검을 받았습니다. 방패에 반사된 메두사의 모습만 보면서 접근해 목을 베는 데 성공했어요. 귀환길에 바위에 묶인 안드로메다를 구하고 괴물도 처치했습니다. 메두사의 머리는 섬의 왕을 돌로 만드는 데 썼고, 어머니를 구했어요. 【결말】 신탁은 결국 이루어졌어요. 페르세우스가 원반 던지기 경기에 참가했다가 바람에 원반이 빗나가 우연히 관중석의 아크리시오스를 맞혀 죽인 겁니다. 피하려 할수록 신탁에 가까워지는 운명의 아이러니예요. 페르세우스자리의 알골(Algol)은 아랍어로 '악마의 머리' — 메두사의 눈을 상징합니다. 알골은 실제로 밝기가 변하는 식쌍성인데, 고대 이집트 파피루스에 이미 그 주기가 기록되어 있었다는 사실이 최근 밝혀졌어요.",
  ...
  cancer:{
    mythFull: "【배경】 헤라클레스의 두 번째 과업은 레르나 늪의 히드라 처치였어요. 히드라는 머리가 아홉 개 달린 거대한 뱀 괴물인데, 머리를 하나 자르면 그 자리에서 두 개가 새로 돋아나는 끔찍한 재생 능력을 가졌습니다. 헤라는 헤라클레스가 이 과업을 절대 성공 못 하게 하려고 혈안이었어요. 그래서 비장의 카드를 꺼냈는데, 그게 바로 게였습니다. 헤라클레스가 히드라와 정신없이 싸우는 동안, 늪 속에서 게 한 마리를 몰래 보낸 거예요. 【사건】 게는 헤라의 명령대로 늪 밑에서 살금살금 기어나와 헤라클레스의 발을 집게로 꽉 물었습니다. 헤라의 계획은 헤라클레스가 발 통증에 정신이 팔린 틈을 타 히드라가 역전하는 것이었겠죠. 그런데 결과는 처참했어요. 헤라클레스는 거들떠보지도 않고 그냥 발로 밟아버렸습니다. 히드라와 싸우는 와중에 발밑의 게 따위는 신경 쓸 여유도 없었던 거예요. 게는 임무도 완수 못 하고, 그렇다고 영웅적인 최후도 아닌 허무한 죽음을 맞이했습니다. 【결말】 헤라는 이 게의 충성심과 희생 정신을 가상히 여겨 하늘에 올렸어요. 덕분에 황도 12궁 중 하나가 됐지만, 워낙 어두운 별들로 이루어져 있어서 도심에서는 거의 안 보입니다. 그 대신 게자리 안에 숨어있는 M44 벌집성단이 볼만해요. 맑은 날 맨눈으로 보면 희뿌연 구름처럼 보이는데, 고대 동양에선 이걸 '적시기(積屍氣)', 즉 쌓인 시체의 기운이라 불렀어요. 이 흐릿한 얼룩이 안 보이면 곧 비가 온다는 날씨 예보로도 쓰였답니다.",
  ...
  coronaBorealis:{
    mythFull: "【배경】 크레타의 공주 아리아드네는 미궁 속 괴물 미노타우로스를 물리치러 온 아테네 왕자 테세우스와 사랑에 빠졌어요. 아리아드네는 테세우스에게 실타래를 건네 미궁에서 빠져나오는 방법을 알려줬습니다. 테세우스는 미노타우로스를 처치하고 아리아드네와 함께 크레타를 탈출했어요. 그런데 귀환 도중 낙소스 섬에 잠시 들렀다가, 테세우스는 혼자 배를 타고 가버렸습니다. 버림받은 아리아드네는 섬 해변에 홀로 남겨졌어요. 왜 버렸는지는 신화마다 달라요 — 그냥 차버렸다는 설, 아테나 여신의 명령이었다는 설, 실수로 두고 갔다는 설까지. 【사건】 아리아드네가 해변에서 울고 있을 때 나타난 게 포도주의 신 디오니소스였습니다. 화려한 행렬을 이끌고 낙소스 섬에 도착한 디오니소스는 눈물 가득한 아리아드네를 보자마자 반해버렸어요. 신이 직접 다가가 위로하고 청혼했습니다. 버림받아 절망한 공주에게 신이 나타나 구혼한 셈이니, 테세우스에게는 미안하지만 아리아드네 입장에서는 더 나은 결말이었을 수도 있겠죠. 아리아드네는 청혼을 받아들였고, 디오니소스와 결혼식을 올렸습니다. 【결말】 디오니소스는 결혼 선물로 보석이 박힌 황금 왕관을 아리아드네에게 주었습니다. 아리아드네가 세상을 떠난 후, 디오니소스는 그 왕관을 하늘로 던져 별자리로 만들었어요. 그게 북쪽왕관자리입니다. C자 반원 모양으로 7개의 별이 늘어선 모습이 꽤 왕관스럽죠. 목동자리 아크투루스 바로 옆에 있어서, 봄의 대곡선을 따라가다 보면 자연스럽게 눈에 들어옵니다. 동양에선 이 별들을 관삭(貫索) — 감옥의 사슬로 불렀는데, 같은 별 모양을 보고 이렇게 다른 의미를 떠올렸다는 게 흥미롭죠.",
  ...
  hercules:{
    mythFull: "【배경】 헤라클레스는 태어나는 순간부터 헤라 여신의 표적이었어요. 제우스가 인간 여인 알크메네와의 사이에서 낳은 아들이었으니까요. 헤라는 요람 속 아기 헤라클레스를 죽이려고 독사 두 마리를 보냈는데, 아기 헤라클레스가 두 손으로 뱀을 잡아 죽여버렸습니다. 이미 그때부터 범상치 않았던 거죠. 성인이 된 후 헤라가 광기를 불어넣어 헤라클레스가 자기 자식들을 죽이는 비극이 벌어졌고, 그 속죄로 신탁이 내린 12가지 과업을 수행하게 됩니다. 【사건】 12과업은 그야말로 불가능의 연속이었어요. 죽지 않는 히드라를 처치하고, 황금 사슴을 잡되 다치게 하면 안 되고, 아우게이아스 왕의 30년 묵은 외양간을 하루에 치우고, 새떼가 들끓는 호수를 정리하고, 지옥의 파수견 케르베로스를 맨손으로 잡아오기까지. 매번 에우리스테우스 왕은 조건을 바꾸거나 트집을 잡았지만, 헤라클레스는 끝내 12과업을 모두 완수했습니다. 그 사이 사자 가죽을 벗겨 갑옷을 만들고, 히드라의 독을 화살에 발라 최강의 무기도 손에 넣었어요. 【결말】 모든 과업을 마친 헤라클레스는 결국 올림포스에 올라 불멸의 존재가 됐습니다. 헤라도 화해하고 딸 헤베를 아내로 주었어요. 그런데 하늘에서 헤라클레스자리를 보면 좀 이상합니다 — 머리를 아래로 향한 채 무릎을 꿇고 있는 모습이거든요. 영웅인데 왜 이런 자세냐고요? 신화학자들도 여전히 의견이 엇갈리지만, 가장 유력한 설은 용자리 위에 올라타 용의 머리를 밟고 있는 것이라는 해석입니다. 여름 밤하늘에서 베가(거문고자리)와 아크투루스(목동자리) 사이에서 찾을 수 있어요.",
  ...
  delphinus:{
    mythFull: "【배경】 바다의 신 포세이돈은 신들 중에서도 손꼽히는 구혼 실패 전문가였어요. 반해서 쫓아가면 상대가 도망치는 패턴이 반복됐습니다. 바다 님프 암피트리테도 포세이돈의 구혼을 거절하고 아틀라스 산 끝으로 도망쳐버렸어요. 포세이돈이 전령들을 보내 설득을 시도했는데, 다들 실패했습니다. 마지막으로 나선 게 돌고래였어요. 【사건】 돌고래는 암피트리테를 찾아가서 거칠게 설득하는 대신, 포세이돈이 얼마나 진심인지를 조곤조곤 이야기했습니다. 바다의 신이 직접 구혼하러 온 게 얼마나 드문 일인지, 포세이돈이 얼마나 간절한지를 말했어요. 돌고래의 설득이 통했는지, 암피트리테가 마음을 바꿔 포세이돈의 청혼을 받아들였습니다. 포세이돈과 암피트리테는 바다의 왕과 왕비가 됐어요. 돌고래 덕분에 이루어진 결혼이었습니다. 【결말】 포세이돈은 중매를 서준 돌고래에게 감사해서 하늘에 올려 별자리로 만들었습니다. 돌고래자리는 작지만 꽤 귀여운 별자리예요. 별 4개가 마름모꼴로 모여 있고 꼬리별이 하나 달린 모습이, 정말 돌고래가 물 위로 튀어오른 것처럼 보입니다. 별 이름도 재미있어요 — 수알로킨(Sualocin)과 로타네프(Rotanev)는 19세기 이탈리아 천문학자 니콜라우스 베나토르(Nicolaus Venator)의 이름을 라틴어로 바꾼 뒤 거꾸로 쓴 것입니다. 몰래 자기 이름을 별에 붙인 역대급 셀프 작명이에요.",
  ...
  pegasus:{
    mythFull: "【배경】 페가수스는 탄생부터 범상치 않아요. 페르세우스가 고르곤 세 자매 중 하나인 메두사의 목을 벨 때, 흘러내린 메두사의 피에서 날개 달린 백마가 튀어나왔습니다. 그게 페가수스예요. 어머니가 포세이돈이라는 설이 있어서인지, 페가수스는 처음에 바다 거품 속에서 나왔다는 버전도 있어요. 태어나자마자 하늘로 날아올라 헬리콘 산에 내려앉았고, 발굽으로 땅을 차서 샘을 만들었습니다. 그 샘이 히포크레네 — 시인들에게 영감을 주는 신성한 샘이에요. 【사건】 페가수스를 길들인 영웅은 벨레로폰입니다. 아테나가 꿈속에서 황금 굴레를 건네줬고, 벨레로폰은 그걸로 페가수스를 길들였어요. 함께 사자 머리에 염소 몸통, 뱀 꼬리를 가진 불을 뿜는 괴물 키마이라를 처치했고, 아마존 여전사들과도 싸워 이겼습니다. 연전연승에 자만심이 극에 달한 벨레로폰은 결국 페가수스를 타고 올림포스까지 날아오르려 했어요. 신의 영역에 감히 인간이 들어오려 하자, 제우스가 등에를 보내 페가수스를 물게 했고, 벨레로폰은 땅으로 떨어졌습니다. 【결말】 페가수스만 홀로 올림포스에 올라갔고, 제우스의 천마가 되어 번개와 벼락을 나르는 역할을 맡았습니다. 결국 하늘의 별자리가 됐는데, 가을 밤하늘에 보이는 '가을의 대사각형'이 바로 페가수스의 몸통이에요. 네 꼭짓점 중 하나는 사실 안드로메다자리의 별이라, 페가수스와 안드로메다가 별 하나를 공유하고 있는 셈입니다. 밤하늘에서 커다란 빈 사각형을 찾으면 바로 그게 페가수스예요.",
  ...
  aries:{
    mythFull: "【배경】 보이오티아의 왕 아타마스에게는 프릭소스와 헬레라는 남매가 있었어요. 왕이 재혼한 계모 이노가 문제였습니다. 계모는 전처 자식들을 없애려고 치밀한 계획을 세웠어요. 먼저 씨앗을 볶아 농사가 망하게 만들고, 그 흉년의 원인이 프릭소스라는 가짜 신탁을 꾸몄습니다. 왕이 신탁을 믿고 아들을 제물로 바치려는 순간, 남매의 친어머니이자 구름의 여신 네펠레가 하늘에서 황금빛 날개 달린 숫양을 내려보냈어요. 아이들을 살리려는 어머니의 마지막 선물이었습니다. 【사건】 프릭소스와 헬레는 황금 양의 등에 올라타 하늘로 날아올랐어요. 그런데 긴 여정 중에 헬레가 그만 양의 등에서 미끄러져 바다로 떨어지고 말았습니다. 그 바다가 헬레스폰토스, 지금의 다르다넬스 해협이에요. 헬레의 이름이 붙은 바다가 된 거죠. 프릭소스 혼자 콜키스 왕국까지 도착했고, 왕 아이에테스가 따뜻하게 맞아줬습니다. 프릭소스는 감사의 뜻으로 황금 양을 제우스에게 제물로 바쳤고, 그 황금 양털을 아이에테스 왕에게 선물했어요. 【결말】 아이에테스 왕은 황금 양털을 성스러운 숲 나무에 걸어두고 잠들지 않는 용으로 지키게 했습니다. 이 황금 양털이 나중에 이아손과 아르고 원정대가 목숨을 걸고 찾아오는 그 전설의 양털이에요. 양자리는 황도 12궁의 시작점이기도 합니다. 약 2000년 전 춘분점이 양자리에 있었기 때문인데, 세차운동으로 지금은 춘분점이 물고기자리로 옮겨갔지만 여전히 양자리가 황도의 출발점으로 불립니다.",
  ...
  canisMinor:{
    mythFull: "【배경】 작은개자리의 프로키온(Procyon)은 이름 자체가 '개보다 먼저 뜨는 별'이라는 뜻이에요. 시리우스(큰개자리)보다 먼저 지평선에 떠오르기 때문에 붙은 이름입니다. 작은개자리는 오리온의 두 사냥개 중 작은 쪽으로, 큰형인 시리우스(큰개자리)와 함께 오리온 곁에서 하늘을 지키고 있어요. 그런데 작은개자리에는 충직함에 관한 더 애절한 이야기가 따로 전해집니다. 목동자리의 이카리오스와 그의 개 마이라 이야기예요. 【사건】 이카리오스가 포도주를 독약으로 오해한 마을 사람들에게 억울하게 죽임을 당하고 숲에 묻혔을 때, 딸 에리고네와 함께 아버지를 찾아 헤맨 게 바로 사냥개 마이라였어요. 들판을 헤매고 또 헤매다가, 마이라가 마침내 이카리오스의 무덤을 찾아냈습니다. 짖고 또 짖으며 에리고네를 무덤으로 안내했죠. 주인의 시신을 발견한 마이라는 그 자리에서 슬픔을 이기지 못하고 죽었다고 해요. 끝까지 주인 곁을 지킨 겁니다. 【결말】 제우스가 이 충직한 개를 불쌍히 여겨 하늘에 올렸습니다. 그게 작은개자리예요. 별은 딱 두 개뿐인 단출한 별자리지만, 프로키온은 밤하늘 전체에서 여덟 번째로 밝은 별입니다. 베텔게우스(오리온자리), 시리우스(큰개자리), 프로키온(작은개자리) 세 별을 이으면 겨울 대삼각형이 완성돼요. 주인을 잃고도 끝까지 곁을 지킨 개가 겨울 하늘의 길잡이 삼각형 꼭짓점 중 하나가 된 셈입니다.",
